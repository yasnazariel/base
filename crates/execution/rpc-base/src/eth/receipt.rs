        ...
        + 'static,
{
    ...
    fn convert_receipts_with_block(
        ...
        let mut l1_block_info = match reth_evm_ethereum::extract_l1_info(block.body()) {
...
impl OpReceiptFieldsBuilder {
    ...
    /// Applies [`L1BlockInfo`](reth_revm::L1BlockInfo).
    pub fn l1_block_info<T: Encodable2718 + OpTransaction>(
        mut self,
        chain_spec: &impl BaseUpgrades,
        tx: &T,
        l1_block_info: &mut reth_revm::L1BlockInfo,
...
mod tests {
    ...
    fn op_receipt_fields_from_block_and_tx() {
        ...
        let mut l1_block_info =
            reth_evm_ethereum::extract_l1_info(&block.body).expect("should extract l1 info");
    ...
    fn op_non_zero_operator_fee_params_included_in_receipt() {
        ...
        let mut l1_block_info = reth_revm::L1BlockInfo {
