...
pub use peers::{
    ...
    kind::PeerKind,
    reputation::{
        DEFAULT_REPUTATION, Reputation, ReputationChangeKind, ReputationChangeOutcome,
        ReputationChangeWeights, is_banned_reputation, is_connection_failed_reputation,
    },
