...
pub use app::{
    ...
    ConfigView, DaMonitorView, DaState, FlashState, FlashblocksView, HomeView, LoadTestTask,
    LoadTestView, ProofsState, ProofsView, Resources, Router, TransactionPane, UpgradesView,
