...
/// [`OpEvm`](reth_revm::OpEvm) type.
#[allow(missing_debug_implementations)] // missing revm::OpContext Debug impl
pub struct OpEvm<DB: Database, I, P = BasePrecompiles> {
    pub(crate) inner:
        reth_revm::OpEvm<OpContext<DB>, I, EthInstructions<EthInterpreter, OpContext<DB>>, P>,
...
impl<DB: Database, I, P> OpEvm<DB, I, P> {
    ...
    /// [`OpEvm`](reth_revm::OpEvm) should be invoked on [`Evm::transact`].
    pub const fn new(
        evm: reth_revm::OpEvm<OpContext<DB>, I, EthInstructions<EthInterpreter, OpContext<DB>>, P>,
        inspect: bool,
    ) -> Self {
...
mod tests {
    ...
    use reth_revm::{bls12_381, bn254_pair};
